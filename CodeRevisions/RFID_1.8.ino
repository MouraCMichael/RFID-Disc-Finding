...
/************** Remain idle until user selects an option *****************************/
void state_2(){
  
  Serial.println("Enter state 2");
  
  clearScreen();  //delay(100);
  searchScreen(); //delay(100);
...
/************** Remain idle until "continue" is pressed (btn 1) *********************/
void state_0(){
...
void homeScreen(){
  ...
  dispMessage(1, ST77XX_RED , 33 + 77, 0, "PRO");

  dispMessage(1, ST77XX_RED , 33, 45, "Search For Disc");
...
void toggleHomeOptions(uint8_t numPressed){
  ...
  if((numPressed % 2) == 0){
    ...
    dispMessage(1, ST77XX_RED , 33, 70, "Change Disc Name");
    Serial.println("even");
  }
...
void searchScreen(){
  dispMessage(1, ST77XX_WHITE , 33, 57, "Searching...");
}

void displayResultsScreen(String discName){
    dispMessage(1, ST77XX_WHITE , 33, 57, discName);
